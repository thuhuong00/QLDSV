...
{
    public partial class frm_BangDiemLTC : Form
    {
        public frm_BangDiemLTC()
        {
            InitializeComponent();
        }
        ...
        private void frm_BangDiemLTC_Load(object sender, EventArgs e)
        {
        ...
        private void btnXemBaoCao_Click(object sender, EventArgs e)
        {
            ...
            rpt_BangDiemLTC report = new rpt_BangDiemLTC(maNienKhoa, cbbMonHoc.SelectedValue.ToString(), int.Parse(txtNhom.Text));
